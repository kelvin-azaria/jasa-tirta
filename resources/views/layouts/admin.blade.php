...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body >
      ...
      <div class="row m-0">
          ...
          <nav style="width: 280px; color:rgb(158, 169, 180);" class="vh-100 col-auto d-none d-md-block border border-right px-3 pb-3 overflow-auto bg-white">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a role="button" data-bs-toggle="collapse" href="#collapseCompetition1" data-bs-toggle="collapse" class="nav-link link-light-theme my-2 px-3 text-capitalize">
              ...
              <ul  id="collapseCompetition1" class="collapse show sidebar-dropdown-link">
                <li class="nav-item">
                  <a role="button" href="{{ url('/') }}" class="nav-link link-light-theme my-1 px-3 text-capitalize"><i class="fas fa-user-friends fa-fw"></i><span class="ps-2 nav-link-text d-inline">participants</span></a>
                </li>
                <li class="nav-item">
                  <a role="button" href="{{ url('/') }}" class="nav-link link-light-theme my-1 px-3 text-capitalize"><i class="fas fa-users fa-fw"></i><span class="ps-2 nav-link-text d-inline">team management</span></a>
                </li>
                <li class="nav-item">
              ...
              <li class="nav-item">
                <a role="button" data-bs-toggle="collapse" href="#collapseCompetition2" data-bs-toggle="collapse" class="nav-link link-light-theme my-2 px-3 text-capitalize"><i class="fas fa-running fa-fw"></i><span class="ps-2  nav-link-text d-inline">run</span></a>
              </li>
              <ul  id="collapseCompetition2" class="collapse show sidebar-dropdown-link">
                ...
                <ul  id="collapseRunLeaderboard" class="collapse show sidebar-dropdown-link">
                  <li class="nav-item">
                    <a role="button" href="{{ route('admin.leaderboard.run.index',['gender' => 'P']) }}" class="nav-link link-light-theme my-1 px-3 text-capitalize"><i class="fa fa-venus fa-fw"></i><span class="ps-2 nav-link-text d-inline">female</span></a>
                  </li>
                  <li class="nav-item">
                    <a role="button" href="{{ route('admin.leaderboard.run.index',['gender' => 'L']) }}" class="nav-link link-light-theme my-1 px-3 text-capitalize"><i class="fa fa-mars fa-fw"></i><span class="ps-2 nav-link-text d-inline">male</span></a>
                  </li>
                </ul>
              </ul>
              <li class="nav-item">
                <a role="button" data-bs-toggle="collapse" href="#collapseCompetition3" data-bs-toggle="collapse" class="nav-link link-light-theme my-2 px-3 text-capitalize"><i class="fas fa-biking fa-fw"></i><span class="ps-2  nav-link-text d-inline">ride</span></a>
              </li>
              <ul  id="collapseCompetition3" class="collapse show sidebar-dropdown-link">
                ...
                <ul  id="collapseRideLeaderboard" class="collapse show sidebar-dropdown-link">
                  <li class="nav-item">
                    <a role="button" href="{{ route('admin.leaderboard.ride.index',['gender' => 'P']) }}" class="nav-link link-light-theme my-1 px-3 text-capitalize"><i class="fa fa-venus fa-fw"></i><span class="ps-2 nav-link-text d-inline">female</span></a>
                  </li>
                  <li class="nav-item">
          ...
          <div id="contentContainer" class="vh-100 col align-self-stretch bg-light overflow-auto h-100 overflow-y-scroll bg-light-accent-4">
            ...
            <div class="row border-bottom bg-light-accent-3 justify-content-between sticky-top bg-white">
              ...
              <div class="col-auto py-3 align-self-center">
                ...
                <a name="" id="" class="nav-link px-4 py-3 link-light-theme rounded-pill text-capitalize d-block d-md-none" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" role="button">
              ...
              <div class="container-fluid">
                <div class="container p-0">
                  ...
                  <div class="row justify-content-between">
                    <div class="col">
                      <a role="button" href="{{ route('admin.dashboard.index') }}" class="nav-link link-light-theme fw-bold text-capitalize py-2 ">
                    ...
                    <div class="col">
                      <a role="button" href="{{ route('admin.users.index') }}" class="nav-link link-light-theme fw-bold text-capitalize py-2 ">
                    ...
                    <div class="col">
                      <a class="nav-link py-2 link-light-theme p-0 fw-bold text-capitalize " data-bs-toggle="collapse" href="#moreNavOptions" role="button" aria-expanded="false" aria-controls="collapseExample">
    ...
    <script
    src="https://cdn.datatables.net/buttons/2.4.0/js/buttons.html5.min.js"></script>
    <script
    src="https://cdn.datatables.net/buttons/2.4.0/js/buttons.print.min.js"></script>
    <script
