      ...
      <div class="row vh-100 overflow-auto">
          ...
          <nav style="width: 280px;" class="col-auto d-none d-md-block border border-right pb-3 vh-100 overflow-auto">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a role="button" href="{{ route('admin.dashboard.index') }}" class="nav-link my-1 px-3 text-capitalize"><i class="fas fa-home fa-fw"></i><span class="ps-2 nav-link-text d-inline">Dashboard</span></a>
              </li>
              <li class="nav-item">
                <a role="button" data-bs-toggle="collapse" href="#collapseEventManagement" data-bs-toggle="collapse" class="nav-link my-2 px-3 text-capitalize"><i class="fas fa-calendar-day fa-fw"></i></i><span class="ps-2  nav-link-text d-inline">event management</span></a>
              </li>
              <ul  id="collapseEventManagement" class="collapse show sidebar-dropdown-link">
                <li class="nav-item">
                  <a role="button" href="{{ url('/') }}" class="nav-link my-1 px-3 text-capitalize"><i class="fas fa-image fa-fw"></i><span class="ps-2 nav-link-text d-inline">banners</span></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a role="button" href="{{ url('/') }}" class="nav-link my-1 px-3 text-capitalize"><i class="fas fa-calendar-alt fa-fw"></i><span class="ps-2 nav-link-text d-inline">calendar</span></a>
                </li>
              </ul>
              <li class="nav-item">
                <a role="button" href="{{ url('/') }}" class="nav-link my-1 px-3 text-capitalize"><i class="fas fa-phone fa-fw"></i><span class="ps-2 nav-link-text d-inline">person in charge</span></a>
              </li>
              <small class="text-muted mt-3 mb-1 fw-bold text-capitalize">data processing</small>
              <li class="nav-item">
                <a role="button" href="{{ route('admin.users.index') }}" class="nav-link my-1 px-3 text-capitalize"><i class="fa fa-address-card fa-fw"></i><span class="ps-2 nav-link-text d-inline">Users</span></a>
              </li>
              <small class="text-muted mt-3 mb-1 fw-bold text-capitalize">competitions</small>
              <li class="nav-item">
                <a role="button" data-bs-toggle="collapse" href="#collapseCompetition1" data-bs-toggle="collapse" class="nav-link my-2 px-3 text-capitalize"><svg  width="20" height="20" version="1.1" viewBox="0 0 752 752" xmlns="http://www.w3.org/2000/svg">
              ...
              <ul  id="collapseCompetition1" class="collapse show sidebar-dropdown-link">
                <li class="nav-item">
                  <a role="button" href="{{ url('/') }}" class="nav-link my-1 px-3 text-capitalize"><i class="fas fa-user-friends fa-fw"></i><span class="ps-2 nav-link-text d-inline">participants</span></a>
                </li>
                <li class="nav-item">
                  <a role="button" href="{{ url('/') }}" class="nav-link my-1 px-3 text-capitalize"><i class="fas fa-users fa-fw"></i><span class="ps-2 nav-link-text d-inline">team management</span></a>
                </li>
                <li class="nav-item">
              ...
              <li class="nav-item">
                <a role="button" data-bs-toggle="collapse" href="#collapseCompetition2" data-bs-toggle="collapse" class="nav-link my-2 px-3 text-capitalize"><i class="fas fa-running fa-fw"></i><span class="ps-2  nav-link-text d-inline">run</span></a>
              </li>
              <ul  id="collapseCompetition2" class="collapse show sidebar-dropdown-link">
                <li class="nav-item">
                  <a role="button" href="{{ route('admin.activity.index.run.user') }}" class="nav-link my-1 px-3 text-capitalize"><i class="fas fa-user-friends fa-fw"></i><span class="ps-2 nav-link-text d-inline">participants</span></a>
                </li>
                <li class="nav-item">
                  <a role="button" data-bs-toggle="collapse" href="#collapseRunLeaderboard" data-bs-toggle="collapse" class="nav-link my-1 px-3 text-capitalize"><i class="fas fa-medal fa-fw"></i><span class="ps-2 nav-link-text d-inline">leaderboard</span></a>
                </li>
                <ul  id="collapseRunLeaderboard" class="collapse show sidebar-dropdown-link">
                  <li class="nav-item">
                    <a role="button" href="{{ route('admin.leaderboard.run.index',['gender' => 'P']) }}" class="nav-link my-1 px-3 text-capitalize"><i class="fa fa-venus fa-fw"></i><span class="ps-2 nav-link-text d-inline">female</span></a>
                  </li>
                  <li class="nav-item">
                    <a role="button" href="{{ route('admin.leaderboard.run.index',['gender' => 'L']) }}" class="nav-link my-1 px-3 text-capitalize"><i class="fa fa-mars fa-fw"></i><span class="ps-2 nav-link-text d-inline">male</span></a>
                  </li>
                </ul>
              </ul>
              <li class="nav-item">
                <a role="button" data-bs-toggle="collapse" href="#collapseCompetition3" data-bs-toggle="collapse" class="nav-link my-2 px-3 text-capitalize"><i class="fas fa-bicycle fa-fw"></i><span class="ps-2  nav-link-text d-inline">ride</span></a>
              </li>
              <ul  id="collapseCompetition3" class="collapse show sidebar-dropdown-link">
                <li class="nav-item">
                  <a role="button" href="{{ route('admin.activity.index.ride.user') }}" class="nav-link my-1 px-3 text-capitalize"><i class="fas fa-user-friends fa-fw"></i><span class="ps-2 nav-link-text d-inline">participants</span></a>
                </li>
                <li class="nav-item">
                  <a role="button" data-bs-toggle="collapse" href="#collapseRideLeaderboard" data-bs-toggle="collapse" class="nav-link my-1 px-3 text-capitalize"><i class="fas fas fa-medal fa-fw"></i><span class="ps-2 nav-link-text d-inline">leaderboard</span></a>
                </li>
                <ul  id="collapseRideLeaderboard" class="collapse show sidebar-dropdown-link">
                  <li class="nav-item">
                    <a role="button" href="{{ route('admin.leaderboard.ride.index',['gender' => 'P']) }}" class="nav-link my-1 px-3 text-capitalize"><i class="fa fa-venus fa-fw"></i><span class="ps-2 nav-link-text d-inline">female</span></a>
                  </li>
                  <li class="nav-item">
                    <a role="button" href="{{ route('admin.leaderboard.ride.index',['gender' => 'L']) }}" class="nav-link my-1 px-3 text-capitalize"><i class="fa fa-mars fa-fw"></i><span class="ps-2 nav-link-text d-inline">male</span></a>
                  </li>
                </ul>
            ...
            <div class="row border-bottom bg-white justify-content-between">
              ...
              <div class="col-auto py-3 align-self-center">
                <a name="" id="" class="btn btn-light-outline text-capitalize d-none d-md-block text-end" href="{{ route('logout') }}" onclick="event.preventDefault();
                  ...
                  <span class="fw-bold text-accent"><i class="fas fa-sign-out-alt pe-2"></i>{{ __('Logout') }}</span>
                </a>
                ...
                <a name="" id="" class="btn btn-light rounded-pill text-capitalize d-block d-md-none" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" role="button">
                     <div class="d-flex justify-content-center fs-2 text-accent"><i class="fas fa-sign-out-alt fa-fw"></i></div>
                </a>
